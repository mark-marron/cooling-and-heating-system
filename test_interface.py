...
The standard user interface was dismantles and a seperate 'client' was created that invokes the same methods that are used in the interface.py file
...
Hence in tests where a value is invalid a default value may be returned
