...
class TestSetRoomInterfaceInvalid(unittest.TestCase):
...
class TestSetRoomInterfaceValid(unittest.TestCase):
    def test_set_room_clicked(self):
...
class TestSetSettingsInterfaceInvalid(unittest.TestCase):
...
class TestSetSettingsInterfaceValid(unittest.TestCase):
    def test_set_settings_clicked(self):
...
class TestGetSettingsInterfaceInvalid(unittest.TestCase):
...
class TestGetSettingsInterfaceValid(unittest.TestCase):
    def test_get_settings_clicked(self):
